-- ============================================================================
-- V27: Expand Incident Categories & Departments
...
INSERT INTO incident_category_departments (incident_category_id, department_id, responsibility_level, created_at, updated_at)
SELECT ic.id, d.id, 'PRIMARY', NOW(), NOW()
